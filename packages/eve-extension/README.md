...
Start from an eve project (eve ≥ 0.47.0 — the prebuilt extension is built with eve 0.47.3 and its compatibility manifest requires tool contract v21, which eve 0.47.0 is the first release to support; the package declares this as its `eve` peer range), then:
