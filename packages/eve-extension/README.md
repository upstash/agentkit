...
Start from an eve project (eve ≥ 0.54.3 — the prebuilt extension is built with eve 0.54.3 and its compatibility manifest requires tool contract v36 (dynamicTool v34, hook v22), which eve 0.54.3 is the first release to support; the package declares this as its `eve` peer range), then:
