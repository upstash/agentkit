...
Start from an eve project (eve ≥ 0.45.1 — the prebuilt extension is built with eve 0.45.2 and its compatibility manifest requires tool contract v19, which eve 0.45.1 is the first release to support; the package declares this as its `eve` peer range), then:
