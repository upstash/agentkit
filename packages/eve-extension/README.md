...
Start from an eve project (eve ≥ 0.58.0 — the prebuilt extension is built with eve 0.58.1 and its compatibility manifest requires tool contract v45 (dynamicTool v43, hook v22), which eve 0.58.0 is the first release to support; the package declares this as its `eve` peer range), then:
