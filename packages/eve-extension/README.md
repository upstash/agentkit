...
Start from an eve project (eve ≥ 0.47 — the prebuilt extension's compatibility manifest requires 0.47's contribution formats; the package declares this as its `eve` peer range), then:
