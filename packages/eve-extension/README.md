...
Start from an eve project (eve ≥ 0.45 — the prebuilt extension's compatibility manifest requires 0.45's contribution formats; the package declares this as its `eve` peer range), then:
