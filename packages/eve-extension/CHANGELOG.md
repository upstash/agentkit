...
- 3a6b0b5: chore: rebuild against eve 0.52.3 and raise the `eve` peer floor to `>=0.52.3`
  ...
  **Unlike the `0.10.0` rebuild, this one does not fix a break.** eve 0.52.3 _added_ tool 31/32
