  ...
  return (
    <>
      ...
      <p className="muted">
        ...
        <code>aggregate</code> / <code>count</code>), a cached tool (<code>convert_price</code>),
        rate-limited with <code>createRateLimit</code> before the model call. Backed by a real Upstash
        Redis; set{" "}
